...
export class PublicSucursalesService {
  constructor(
    ...
    // Cachea 30s los listados públicos más pedidos (Home los pide en cada
    // apertura de la app, casi siempre con los mismos filtros por ciudad).
    // Sin esto, cada carga de Home dispara varias queries a MySQL en
    // paralelo y agota el pool de conexiones bajo tráfico concurrente real.
