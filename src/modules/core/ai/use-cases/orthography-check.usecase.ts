...
export class OrthographyCheckUseCase {
  ...
  execute(texto: string): string {
    ...
    t = t
      ...
      .replace(/\bchelitas\b/gi, 'cervezas')
      .replace(/\bchelita\b/gi, 'cerveza')
      .replace(/\bcaguamitas\b/gi, 'caguamas')
      .replace(/\bcaguamita\b/gi, 'caguama')
      .replace(/\bkiwasakis\b/gi, 'cervezas')
      .replace(/\bkiwasaki\b/gi, 'cerveza')
      .replace(/\bkiwas\b/gi, 'cervezas')
      .replace(/\bkiwa\b/gi, 'cerveza')
      .replace(/\bcervechas\b/gi, 'cervezas')
      .replace(/\bcervecha\b/gi, 'cerveza')
      .replace(/\bbaras\b/gi, 'baratas')
      .replace(/\bbara\b/gi, 'barata')
