...
export class JwtAuthGuard implements CanActivate {
  constructor(
    ...
    // Cachea el SELECT de revalidación por unos segundos: este guard corre en
    // CADA request autenticado, así que sin caché cada tap del usuario en la
    // app dispara una query a MySQL. Bajo carga concurrente (varias pantallas
    // pidiendo datos a la vez) eso agota el pool de conexiones. TTL corto
    // (30s por defecto) mantiene la revalidación de seguridad "casi" en vivo.
